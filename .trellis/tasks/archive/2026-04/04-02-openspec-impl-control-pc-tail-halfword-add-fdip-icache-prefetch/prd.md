...
## Goal
Imported from OpenSpec change `add-fdip-icache-prefetch` at `.worktrees/impl-control-pc-tail-halfword/openspec/changes/add-fdip-icache-prefetch`.
...
## Technical Notes
- Source workspace: `impl-control-pc-tail-halfword`
- Source OpenSpec root: `.worktrees/impl-control-pc-tail-halfword/openspec`
- Source change dir: `.worktrees/impl-control-pc-tail-halfword/openspec/changes/add-fdip-icache-prefetch`
- Imported checklist progress: 0/88
