...
## Goal
Imported from OpenSpec change `add-fdip-icache-prefetch` at `openspec/changes/add-fdip-icache-prefetch`.
...
- Source OpenSpec root: `openspec`
- Source change dir: `openspec/changes/add-fdip-icache-prefetch`
