...
"""
Extract key events from gem5 debug log after a given tick.

Usage examples:
  - All events after a tick:
      python3 util/extract_gem5_events.py m5out_insts/debug.log --from-tick 480000
  - Only buildInst + commit:
      python3 util/extract_gem5_events.py m5out_insts/debug.log --from-tick 480000 --no-squash
  - Custom regex:
      python3 util/extract_gem5_events.py m5out_insts/debug.log --from-tick 480000 \
...
def main():
    ...
    if args.debug:
        ...
        eprint("[extract_gem5_events] Debug summary")
