#ifndef __MEM_CACHE_LLC_SLICED_CACHE_ACCESSOR_HH__
#define __MEM_CACHE_LLC_SLICED_CACHE_ACCESSOR_HH__
...
public:
    SlicedCacheAccessor(L3CacheWrapper* l3_wrapper)
...
#endif // __MEM_CACHE_LLC_SLICED_CACHE_ACCESSOR_HH__