#ifndef __MEM_CACHE_XS_L2_L3_CACHE_WRAPPER_HH__
#define __MEM_CACHE_XS_L2_L3_CACHE_WRAPPER_HH__
...
/**
 * @brief This L3CacheWrapper acts as a router/dispatcher to a set of L2 cache
...
class L3CacheWrapper : public ClockedObject
{
  ...
  private:
    ...
    friend class SlicedCacheAccessorL3;
    ...
    SlicedCacheAccessorL3 sliced_cache_accessor;
...
#endif // __MEM_CACHE_XS_L2_L3_CACHE_WRAPPER_HH__
