#ifndef __MEM_CACHE_PREFETCH_COMPOITE_WITH_WORKER_L3_HH__
#define __MEM_CACHE_PREFETCH_COMPOITE_WITH_WORKER_L3_HH__
...
{
  public:
    L3CompositeWithWorkerPrefetcher(const L3CompositeWithWorkerPrefetcherParams &p);
...
#endif  // __MEM_CACHE_PREFETCH_COMPOITE_WITH_WORKER_L3_HH__
