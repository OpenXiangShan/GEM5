...
class L3CacheSlice : public CacheWrapper
{
  public:
    ...
    // L3CacheWrapper will call this to provide the implementation for getDataBankIdx.
    void setGetDataBankIdxFunc(std::function<Addr(Addr)> func) {
        getDataBankIdx = func;
    }

    // L3CacheWrapper will call this to provide the implementation for getDirBankIdx.
  ...
  protected:
    ...
    bool innerCpuPortSendTimingReq(PacketPtr pkt, L3TaskSource source);
