                         ...
                         p.shadow_attach_points.end())
{
    ...
    const AttachTarget rnTarget = parseAttachPoint("mesh0.local0", meshes, "RN");
    ...
    inform("xsCHI endpoint summary: RN@M0.local0 node_id=%u, HN_count=%u, "
           "DRAM_count=%u, shadow_count=%u",
           l2Id, static_cast<unsigned>(hns.size()),
           static_cast<unsigned>(drams.size()),
           static_cast<unsigned>(shadowBridges.size()));
