  ...
  public:
    ...
    struct TageEntry
    {
        public:
            ...
            bool newborn;   // Guard bit: 1 when newly allocated and protected
            ...
            TageEntry() :
                ...
                newborn(false), pc(0), lruCounter(0) {}

            TageEntry(Addr tag, short counter, Addr pc) :
                      valid(true), tag(tag), counter(counter),
                      useful(false), newborn(true), pc(pc), lruCounter(0) {}
            bool taken() const {
                return counter >= 0;
            }
    };
