...
{
    DirectionUpdateEntry later{0x1100, true, false, true, false};
    DirectionUpdateEntry not_taken{0x1000, false, false, true, false};
    DirectionUpdateEntry first{0x1080, true, false, true, false};
