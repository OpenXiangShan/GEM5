...
DecoupledBPUWithBTB::DBPBTBStats::DBPBTBStats(
    ...
    ADD_STAT(pairtageSecondBlockNoFirstBlockCandidate, statistics::units::Count::get(),
             "Second-block emission attempts skipped because PairTAGE had no valid first-block candidate"),
    ADD_STAT(pairtageSecondBlockNoFirstBlockLookupMiss, statistics::units::Count::get(),
             "Second-block skips with no first-block candidate because PairTAGE lookup missed"),
    ADD_STAT(pairtageSecondBlockNoFirstBlockUntrainable, statistics::units::Count::get(),
             "Second-block skips with no first-block candidate because final first block is untrainable"),
    ADD_STAT(pairtageSecondBlockFirstBlockMismatchFallThru, statistics::units::Count::get(),
             "Second-block emission attempts skipped because PairTAGE first block mismatched final taken/fallthrough"),
    ADD_STAT(pairtageSecondBlockFirstBlockMismatchControlAddr, statistics::units::Count::get(),
             "Second-block emission attempts skipped because PairTAGE first block mismatched final control address"),
    ADD_STAT(pairtageSecondBlockFirstBlockMismatchTarget, statistics::units::Count::get(),
             "Second-block emission attempts skipped because PairTAGE first block mismatched final target"),
