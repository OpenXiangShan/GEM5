...
DecoupledBPUWithBTB::DBPBTBStats::DBPBTBStats(
    ...
    ADD_STAT(twoTakenUbtbMissDrops, statistics::units::Count::get(),
               "PairTAGE second blocks dropped because the uBTB checker missed or overflowed"),
    ADD_STAT(twoTakenPreExitUncondDrops, statistics::units::Count::get(),
    "PairTAGE second blocks dropped because MBTB found an unconditional branch before the checker exit"),
    ADD_STAT(twoTakenNotTakenUncondDrops, statistics::units::Count::get(),
    "MBTB unconditional entries suppressed for Not-Taken PairTAGE second blocks"),
    ADD_STAT(twoTakenSupplementalEntriesMerged, statistics::units::Count::get(),
               "Layout entries merged around accepted PairTAGE second-block exits"),
