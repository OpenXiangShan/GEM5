...
class TimedBaseFTBPredictor: public SimObject
{
    ...
    virtual void specUpdateHist(const boost::dynamic_bitset<> &history, FullFTBPrediction &pred) {}  // 推测更新历史
    virtual void recoverHist(const boost::dynamic_bitset<> &history, const FetchStream &entry, int shamt, bool cond_taken) {}  // squash后恢复历史
