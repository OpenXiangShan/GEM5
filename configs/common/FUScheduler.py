...
class KMHV3ExploreScheduker(Scheduler):
    __intIQs = [
        IssueQue(name='intIQ4', inports=2, size=16, oports=[
            IssuePort(fu=[IntALU()], rp=[IntRD(8, 0), IntRD(9, 0)])
        ]),
        IssueQue(name='intIQ5', inports=2, size=16, oports=[
            IssuePort(fu=[IntALU(), IntDiv(), IntMisc()], rp=[IntRD(10, 0), IntRD(11, 0)])
        ]),
        ...
        IssueQue(name='intIQ2', inports=2, size=16, oports=[
            IssuePort(fu=[IntALU(), IntBRU()], rp=[IntRD(4, 0), IntRD(5, 0)])
        ]),
        IssueQue(name='intIQ3', inports=2, size=16, oports=[
            IssuePort(fu=[IntALU(), IntBRU()], rp=[IntRD(6, 0), IntRD(7, 0)])
        ]),
    ]
    __memIQs = [
        IssueQue(name='ld0', inports=2, size=16, oports=[
            IssuePort(fu=[ReadPort()], rp=[IntRD(12, 0)])
        ]),
        IssueQue(name='hy0', inports=2, size=16, oports=[
            IssuePort(fu=[ReadPort()], rp=[IntRD(13, 0)])
        ]),
        IssueQue(name='hy1', inports=2, size=16, oports=[
            IssuePort(fu=[ReadPort()], rp=[IntRD(14, 0)]),
            IssuePort(fu=[WritePort()], rp=[IntRD(5, 1)]),
            IssuePort(fu=[StoreDataPort()], rp=[IntRD(9, 1), FpRD(12, 0)])
        ]),
        IssueQue(name='stad0', inports=2, size=16, oports=[
            IssuePort(fu=[WritePort()], rp=[IntRD(7, 1)]),
            IssuePort(fu=[StoreDataPort()], rp=[IntRD(11, 1), FpRD(13, 0)])
        ])
    ]
    __fpIQs = [
        IssueQue(name='fpIQ0', inports=2, size=18, oports=[
            IssuePort(fu=[FP_ALU(), FP_MAC()], rp=[FpRD(0,0), FpRD(1, 0), FpRD(2,0)]),
        ]),
        IssueQue(name='fpIQ1', inports=2, size=18, oports=[
            IssuePort(fu=[FP_ALU(), FP_MAC()], rp=[FpRD(3,0), FpRD(4,0), FpRD(5,0)]),
        ]),
        ...
        IssueQue(name='fpIQ3', inports=2, size=18, oports=[
            IssuePort(fu=[FP_ALU(), FP_MISC(), FP_MAC()], rp=[FpRD(9,0), FpRD(10,0), FpRD(11,0)]),
